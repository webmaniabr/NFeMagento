...
namespace Webmaniabr\Nfe\Block\Checkout;
...
class LayoutProcessor implements \Magento\Checkout\Block\Checkout\LayoutProcessorInterface {
    ...
    public function __construct(
        ...
        \Webmaniabr\Nfe\Helper\DataAddress $addressLineHelper
    ){
    ...
    public function modifyStreetUiComponents($addressResult)
    {
        ...
        if(isset($addressResult['street']['config']['template'])) {
            $addressResult['street']['config']['template'] = 'webmaniabr_nfe_AddressLines/group/group';
        }

        if(isset($addressResult['street']['config']['additionalClasses'])) {
            $addressResult['street']['config']['additionalClasses'] = $addressResult['street']['config']['additionalClasses'] . ' webmaniabr-nfe-configs';
        }
        ...
        while($lineCount < 4){
            ...
            if(isset($addressResult['street']['children'][$lineCount])){
                ...
                if ( $this->addressLineHelper->isLineEnabled($lineNumber)) {
                    ...
                    $addressResult['street']['children'][$lineCount]['additionalClasses'] = 'webmaniabr-nfe-configs-one';
