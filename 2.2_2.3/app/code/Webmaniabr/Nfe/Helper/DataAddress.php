...
class DataAddress extends \Magento\Framework\App\Helper\AbstractHelper
{
    protected $resource;
    ...
    {
        $section = ($section) ? $section : 'webmaniabr_nfe_address';
        $group = ($group) ?  $group : 'webmaniabr_nfe_address_lines';
    ...
    {
        $group = "webmaniabr_nfe_address_lines/webmaniabr_nfe_address_line{$lineNumber}";
